...
def run_tests():
    ...
    for index, raw_input in enumerate(TEST_INPUTS, start=1):
        ...
        narrative = update_narrative_model(before, segments, raw_input)
        ...
        report = build_report(raw_input, before, narrative, segments, mental, intent, collision, implications, plan, answer)
        ...
        results.append({"index": index, "input": raw_input, "passed": passed, "collision": collision["type"], "move": plan["move"]})
